...
<script src="../static/pages/js/usersList.js?v=1.1" type="text/javascript"></script>
		...
		<div class="col-md-12">
			<br/>
				<form id="searchUserListForm" class="form-inline" method="post" role="form">
                    ...
                    <div class="form-group">
                        <select id="province"  name="province" class="form-control" onchange="selectprovince(this);" >
...
<script type="text/javascript">
    ...
    list2[list2.length] = new Array("北京", "东城", "西城", "崇文", "宣武", "朝阳", "丰台", "石景山", " 海淀", "门头沟", "房山", "通州", "顺义", "昌平", "大兴", "怀柔", "平谷", "密云", "延庆", " 其他");
    list2[list2.length] = new Array("和平", "河东", "河西", "南开", "红桥", "塘沽", "汉沽", "大港",
            "西青", "津南", "武清", "蓟县", "宁河", "静海", "其他");
    ...
    list2[list2.length] = new Array("黄浦", "卢湾", "徐汇", "长宁", "静安", "普陀", "闸北", "虹口",
            "杨浦", "闵行", "宝山", "嘉定", "浦东新", "金山", "松江", "青浦", "南汇", "奉贤", "崇明", "其他");
    ...
    list2[list2.length] = new Array("武汉", "十堰", "襄樊", "荆门", "孝感", "黄冈", "鄂州", "黄石",
            "咸宁", "荆州", "宜昌", "随州", "恩施土家族苗族自治州", "仙桃", "天门", "潜江", "神农架林", "其他");
    ...
    list2[list2.length] = new Array("渝中", "大渡口", "江北", "沙坪坝", "九龙坡", "南岸", "北碚",
            "万盛", "双桥", "渝北", "巴南", "万州", "涪陵", "黔江", "长寿", "合川", "永川",
            "江津", "南川", "綦江", "潼南", "铜梁", "大足", "璧山", "垫江", "武隆", "丰都",
            "城口", "开县", "巫溪", "巫山", "奉节", "云阳", "忠县", "石柱土家族自治县", "彭水苗族土家族自治县",
    ...
    function selectprovince(obj) {
        ddlCity.options.length = 1;//clear
